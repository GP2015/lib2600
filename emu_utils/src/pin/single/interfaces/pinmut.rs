    ...
    P: SinglePinCore<'a>,
{
    ...
    delegate! {
        ...
        to self.inner {
            pub fn set_high_in(&mut self, possible: bool) -> Result<(), P::ErrType>;
            pub fn set_low_in(&mut self, possible: bool) -> Result<(), P::ErrType>;
            pub fn set_high_z_in(&mut self, possible: bool);

            pub fn add_high_in(&mut self) -> Result<(), P::ErrType>;
            pub fn add_low_in(&mut self) -> Result<(), P::ErrType>;
            pub fn add_high_z_in(&mut self);
            pub fn set_in(&mut self, signal: PinSignal, possible: bool) -> Result<(), P::ErrType>;
            pub fn add_in(&mut self, signal: PinSignal) -> Result<(), P::ErrType>;
            ...
            pub fn set_all_in(&mut self, possible: bool) -> Result<(), P::ErrType>;
            pub fn add_all_in(&mut self) -> Result<(), P::ErrType>;
